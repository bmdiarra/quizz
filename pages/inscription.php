   	...
   	<div class="row shadow contain">
   		<div class="col-md-3 ">
   			<img src="public/images/img-bg.jpg" alt="..." class="img-thumbnail img_inscri">
            <img src="public/images/img-bg.jpg" alt="..." class="img-thumbnail img_inscri">
            <img src="public/images/img-bg.jpg" alt="..." class="img-thumbnail img_inscri">
   		</div>
   		
   		<div class="col-md-9 contain_formgroup">
      
            <div class="div_inscrirejoueur">
               <h1 class="txt_retour" ><strong>RETOUR A L'ACCEUIL</strong></h1>
            </div>
        ...
        <div class="bg_forminscription row">
         ...
         <div class="div_avatar col-md-6">
            ...
            <div>
   			...
   			<?php //require_once("./pages/inscri2.php"); ?>
   		</div>
